...
<svg class="spinner {className}" width={size} height={size} viewBox="0 0 50 50">
    <defs>
    ...
    <circle class="circle" stroke={type === 'primary' ? 'url(#primary)' : 'url(#secondary)'} cx="25" cy="25" r="20" fill="none" stroke-width={strokeWidth} />
</svg>
